...
{//mettre le implements UserInterface et les 3 dernieres methodes
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=5,minMessage="Votre mot de passe est trop court (minimum 5 caractères)!")
     */
    private $password;
     ...
     */
    public $confirm_password; //dans l idéal le mettre en privé et créé le getter et setter!
